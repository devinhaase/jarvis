...
async def _dispatch_one_incident(brain, incident: dict, broadcast_all=None):
...
async def team_board_dispatch_loop(brain, broadcast_all=None, interval_seconds: int = None):
    ...
    while True:
        try:
            ...
            for incident in open_incidents:
                try:
                    await _dispatch_one_incident(brain, incident, broadcast_all)
